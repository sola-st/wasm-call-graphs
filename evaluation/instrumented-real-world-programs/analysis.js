...
for (const arg of process.argv.slice(2)) {
    ...
    } else if (arg == "--instr-count"){
        get_instr_count = true;
    } else {
    console.log("\
OPTIONS:\n\
      ...
      --instr-count\t\t\tget the number of instructions executed in the Wasm module\
      ");
      process.exit(0); 
  }
}
...
function incInstr(instr_loc) {
    if (instr_count.has(instr_loc)) {
