; ModuleID = '/home/michelle/Documents/sa-for-wasm/wasabi/lib/wasm/tests/callgraph-eval/data/library_data/indirect-call-index-expr-double-load/CG_tools_data/aWsm/awsm.bc'
...
@init_vector_1 = constant <4 x i8> <i8 0, i8 4, i8 0, i8 0>
...
; Function Attrs: nounwind
define i32 @init_memory_offset_1() #1 {
entry:
  br label %exit
...
entry:
  ...
  %1 = call i32 @init_memory_offset_1()
  call void @initialize_region(i32 %1, i32 4, i8* getelementptr inbounds (<4 x i8>, <4 x i8>* @init_vector_1, i32 0, i32 0))
  ret void
}
...
entry:
  ...
  %1 = add i32 %0, 0
  call void @add_function_to_table(i32 %1, i32 0, i8* bitcast (void ()* @wasmf_internal_2 to i8*))
  %2 = add i32 %0, 1
  call void @add_function_to_table(i32 %2, i32 0, i8* bitcast (void ()* @wasmf_internal_1 to i8*))
  ret void
}
