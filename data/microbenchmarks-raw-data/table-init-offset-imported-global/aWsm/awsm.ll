; ModuleID = '/home/michelle/Documents/sa-for-wasm/wasabi/lib/wasm/tests/callgraph-eval/data/library_data/table-init-offset-imported-global/CG_tools_data/aWsm/awsm.bc'
source_filename = "main.wasm"

@host_element_offset = external constant i32
...
entry:
  %0 = call i8* @get_function_from_table(i32 1, i32 0)
...
entry:
  %0 = load i32, i32* @host_element_offset, align 4
  br label %exit
