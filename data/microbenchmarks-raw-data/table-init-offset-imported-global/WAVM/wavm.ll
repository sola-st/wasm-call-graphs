...
entry:
  ...
  %16 = icmp ult i64 1, %15, !dbg !5
  %17 = select i1 %16, i64 1, i64 %15, !dbg !5
...
callIndirectFailTrap:                             ; preds = %entry
  ...
  call void @callIndirectFail(i8* %27, i64 1, i64 udiv exact (i64 sub (i64 ptrtoint (i8* @tableOffset0 to i64), i64 6128), i64 16), %Object* %26, i64 ptrtoint (i8* @typeId0 to i64)), !dbg !5
  unreachable, !dbg !5
