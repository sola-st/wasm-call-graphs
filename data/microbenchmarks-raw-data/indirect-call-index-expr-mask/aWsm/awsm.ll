; ModuleID = '/home/michelle/Documents/sa-for-wasm/wasabi/lib/wasm/tests/callgraph-eval/data/library_data/indirect-call-index-expr-mask/CG_tools_data/aWsm/awsm.bc'
...
entry:
  ...
  %1 = and i32 %0, 1
  %2 = call i8* @get_function_from_table(i32 %1, i32 0)
...
entry:
  ...
  %3 = add i32 %0, 2
  call void @add_function_to_table(i32 %3, i32 0, i8* bitcast (void ()* @wasmf_internal_3 to i8*))
  ret void
}
