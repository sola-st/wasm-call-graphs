...
define fastcc { i8*, {} } @functionDef2(i8*, i32) #0 prefix [4 x i64] [i64 1, i64 ptrtoint (i8* @functionDefMutableDatas2 to i64), i64 sub (i64 ptrtoint (i8* @biasedInstanceId to i64), i64 1), i64 ptrtoint (i8* @typeId1 to i64)] personality i32 ()* @__gxx_personality_v0 !dbg !10 {
entry:
  %context = alloca i8*
  store i8* %0, i8** %context
...
return:                                           ; preds = %entry
  %7 = load i8*, i8** %context, !dbg !14
  %8 = insertvalue { i8*, {} } zeroinitializer, i8* %7, 0, !dbg !14
  ret { i8*, {} } %8, !dbg !14
}
...
!10 = distinct !DISubprogram(name: "functionDef2", linkageName: "functionDef2", scope: !1, file: !1, type: !11, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !2)
