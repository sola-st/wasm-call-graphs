; ModuleID = '/home/michelle/Documents/sa-for-wasm/wasabi/lib/wasm/tests/callgraph-eval/data/library_data/indirect-call-type-based/CG_tools_data/aWsm/awsm.bc'
...
entry:
  %0 = call i8* @get_function_from_table(i32 0, i32 0)
...
; Function Attrs: nounwind
define void @wasmf_internal_2(i32 %0) #1 {
entry:
  br label %exit
...
entry:
  ...
  %1 = add i32 %0, 0
  call void @add_function_to_table(i32 %1, i32 0, i8* bitcast (void ()* @wasmf_internal_1 to i8*))
  %2 = add i32 %0, 1
  call void @add_function_to_table(i32 %2, i32 1, i8* bitcast (void (i32)* @wasmf_internal_2 to i8*))
  ret void
}
