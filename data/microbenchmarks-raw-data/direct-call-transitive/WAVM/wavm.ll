...
entry:
  ...
  %6 = call fastcc { i8*, {} } @functionDef1(i8* %5), !dbg !5
...
entry:
  ...
  %6 = call fastcc { i8*, {} } @functionDef2(i8* %5), !dbg !8
...
entry:
  ...
  %6 = call fastcc { i8*, {} } @functionDef4(i8* %5), !dbg !13
  %7 = extractvalue { i8*, {} } %6, 0, !dbg !13
  store i8* %7, i8** %context, !dbg !13
  %8 = load i8*, i8** %context, !dbg !13
  %9 = ptrtoint i8* %8 to i64, !dbg !13
  %10 = and i64 %9, -2147483648, !dbg !13
  %11 = inttoptr i64 %10 to i8*, !dbg !13
  br label %return, !dbg !14

return:                                           ; preds = %entry
  %12 = load i8*, i8** %context, !dbg !14
  %13 = insertvalue { i8*, {} } zeroinitializer, i8* %12, 0, !dbg !14
  ret { i8*, {} } %13, !dbg !14
}
